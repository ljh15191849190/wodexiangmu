...
var searchData = {};
var PurchaseleadCancel_vue = new Vue({
    el: '#app',
    data: {
        productrange: {
            first: "",
    ...
    methods: {
        ...
        Add: function () {
            //取得选择行数据
            var selectRow = PageCommon.GetTableSelectRow("InboundFormLeadList");
            //画面选择一条数据
        ...
        Search: function () {
            var that = this;
            that.searchModel = $("#searchForm").GetSearchModel({ Menu_Id: "M000010", List_Id: "InboundFormLeadList" });
        },
    }
});