var SupplierfilingChange = new Vue({
    ...
    methods: {
        ...
        CheckLook: function () {
            ...
            window.location.href = PageCommon.SetUrlParameter("OutDetail", "relevantnumber=" + selectRow[0].Alter_Apply_Id + '&sourcetype=0&isedit=1&sourcelist=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
        },
        //详细画面新增跳转
        New: function () {
        ...
        Approval: function () {
            ...
            //详细画面更新跳转
            window.location.href = PageCommon.SetUrlParameter("OutDetail", "relevantnumber=" + selectRow[0].Alter_Apply_Id + '&sourcetype=1&isedit=1&sourcelist=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
        },
        //详细画面更新跳转
        Update: function () {
            //取得选择行数据
            ...
            //详细画面更新跳转
            window.location.href = PageCommon.SetUrlParameter("OutDetail", "relevantnumber=" + selectRow[0].Alter_Apply_Id + '&sourcetype=0&isedit=0&sourcelist=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
        },
        //删除
        Delete: function () {
            var that = this;
