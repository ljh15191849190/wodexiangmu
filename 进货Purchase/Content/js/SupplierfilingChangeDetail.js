        ...
        if (relevantnumber) {
            PageCommon.GetFormData({
                ...
                success: function (data) {
                    ...
                    var addressArr = data.SupplierNew.Address_Code_Gather.split('-');
                    that.addressCommon = {
                        Address: data.SupplierNew.Address_Gather,
                        DetailAddress: data.SupplierNew.Detail_Address,
        ...
        ConfirmSave: function () {
            ...
            PageCommon.SubmitForm({
                ...
                success: function (data) {
                    ...
                    window.location.href = PageCommon.SetUrlParameter("Detail", "relevantnumber=" + relevantnumber + '&save=1&sourcelist=1');//SourceType：列表0、审核1、提醒2   IsModfiy：0可修改 1不可修改                   
                }
            });
        },
        Edit: function () {
