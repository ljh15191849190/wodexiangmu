var InboundFormCancel_vue = new Vue({
    el: '#apps',
    data: {
        productrange: {
            first: "",
        ...
        childSearchModel: [
           {
               ...
               Child_List: 'InboundFormCancelDetailList',
    ...
    methods: {
        ...
        Edit: function () {
            //取得选择行数据
            var selectRow = PageCommon.GetTableSelectRow("InboundFormCancelList");
            //画面选择一条数据
        ...
        Delete: function () {
            ...
            PageCommon.SubmitDetialForm({
                ...
                type: "0",
                success: function () {
                    PageCommon.RefreshTablePage("InboundFormCancelList");  //刷新数据
                },
                close: true
            })
        },
        ...
        mClear: function () {
            ...
            PageCommon.TableDefaultSort("InboundFormCancelList");
        },
    }
});