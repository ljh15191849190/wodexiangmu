...
var Receiver_vue = new Vue({
    ...
    data: {
        ...
        searchModel: {
            Where_Parameter_List: [{
                Field_Name: "B_Supplier_Receiver.Supplier_Id",
                Query_Type: "01",
                Expression: "02",
                Condition_Value1: "-1",
    ...
    methods: {
        ...
        Save: function () {
            ...
            //获取grid数据
            var data = PageCommon.GetDataTableData("PurchaseProviderReceiverList");
            Receiver_vue.B_Supplier.B_Supplier_Receiver_List = [];
            //组织明细数据 过滤空行
            $.each(data, function (index, item) {
                if (item.Name != "") {
                    ...
                    if (item.Telephone != "" || item.Mobile_Phone != "") {
                        var obj = {};
                        obj.Supplier_Id = Receiver_vue.B_Supplier.Supplier_Id;
                        ...
                        Receiver_vue.B_Supplier.B_Supplier_Receiver_List.push(obj);
                    }
                }
            });

            //验证至少输入一条明细
            if (!Receiver_vue.B_Supplier.B_Supplier_Receiver_List.length > 0) {
            ...
            PageCommon.SubmitForm({
                url: "Save"
             , param: { supplierReceiverList: Receiver_vue.B_Supplier.B_Supplier_Receiver_List }
             , success: function () {
                 //判断新增还是修改
                 if (!!!relevantnumber) {
                     Receiver_vue.B_Supplier = '';
                     PageCommon.Reload();
                 } else {
