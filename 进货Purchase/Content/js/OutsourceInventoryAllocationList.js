var OutInventoryAllocation_vue = new Vue({
    el: '#apps',
    data: {
        productrange: {
            first: "",
        ...
        isedittable: true,
        //编辑表格id数组
        tableid: ['OutPurchaseInventoryList', 'OutPurchaseInventoryAlloctionList'],
        //是否显示分配按钮
        btnDistribute: true,
        //是否显示分配取消按钮
    ...
    mounted: function () {
        ...
        $("#tab").on("click", 'li', function () {
            ...
            PageCommon.RefreshTablePage("OutInventorySummaryList");
            PageCommon.RefreshTablePage("OutPurchaseInventoryList");
            PageCommon.RefreshTablePage("OutPurchaseInventoryAlloctionList");
    ...
    methods: {
        ...
        Distribute: function () {
            ...
            if (that.selectRow.length != 1) {
                ...
                if (Storeage_Id && Distribute) {
                    ...
                    $('#OutPurchaseInventoryList tbody tr').each(function (i) {
                        var item = $.fn.dataTable.Api('#OutPurchaseInventoryList').row(this).data();
        ...
        DistributeCancel: function () {
            var that = this;
            var list = [];
            $('#OutPurchaseInventoryAlloctionList tbody tr').each(function (i) {
                var item = $.fn.dataTable.Api('#OutPurchaseInventoryAlloctionList').row(this).data();
                item.Product_Name = item.Product_Name.substring(0, item.Product_Name.length - 1);
                list.push(item);
            });
            if (list.length) {
        ...
        Search: function () {
            ...
            if (that.btnDistributeCancel) {
                ...
                that.searchModel = $(".form_base1").GetSearchModel({ Menu_Id: "M000014", List_Id: "OutInventorySummaryList" });
                var postdata = {};
        ...
        mClear: function () {
            ...
            PageCommon.TableDefaultSort("OutInventorySummaryList");
        },
        //清除
        mClear2: function () {
            ...
            PageCommon.TableDefaultSort("OutPurchaseInventoryList");
        },
    }
});
