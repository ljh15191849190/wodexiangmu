var InboundForm_vue = new Vue({
        ...
        childSearchModel: [
           {
               ...
               Child_List: 'InboundFormDetailList',
    ...
    methods: {
        ...
        Edit: function () {
            //取得选择行数据
            var selectRow = PageCommon.GetTableSelectRow("InboundFormList");
            //画面选择一条数据
        ...
        Delete: function () {
            ...
            PageCommon.SubmitDetialForm({
                ...
                type: "0",
                success: function () {
                    PageCommon.RefreshTablePage("InboundFormList");  //刷新数据
                },
                close: true
            })
        },
        ...
        Search: function () {
            var that = this;
            that.searchModel = $("#searchForm").GetSearchModel({ Menu_Id: "M000005", List_Id: "InboundFormList" });
        },
        //清除
        mClear: function () {
            ...
            PageCommon.TableDefaultSort("InboundFormList");
        },
    }
});