...
var Purchace_InvoiceRegister_vue = new Vue({
    ...
    data: {
        ...
        searchModel: {
            "Where_Parameter_List": [{
                ...
                Condition_Value1: relevantnumber,
                Expression: "02",
                Module_Id: "FinancialManage",
                Query_Type: "01"
            }]
        },
        Tax_RateOrder: [{}],
        ...
        if (relevantnumber) {
            PageCommon.GetFormData({
                ...
                , success: function (data) {
                    ...
                    Purchace_InvoiceRegister_vue.F_Purchase_Invoice_Register.F_Purchase_Invoice_R_Detail_List = [];
                    //判断状态
    ...
    methods: {
        ...
        TemplateData: function (data) {
            this.F_Purchase_Invoice_Register.Invoice_Type = data.Invoice_Type;
