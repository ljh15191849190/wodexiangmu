    ...
    var ReceiptRefund_vue = new Vue({
        ...
        methods: {
            ...
            Update: function () {
                //取得选择行数据
                var selectRow = PageCommon.GetTableSelectRow("ReceiptRefundList");
                ...
                //详细画面更新跳转
                window.location.href = PageCommon.SetUrlParameter("Detail", "relevantnumber=" + selectRow[0].Receipt_Refund_Id + '&sourcetype=0&isedit=0');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
            ...
            CheckLook: function () {
                ...
                window.location.href = PageCommon.SetUrlParameter("Detail", "relevantnumber=" + selectRow[0].Receipt_Refund_Id + '&sourcetype=0&isedit=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
            ...
            Export: function (obj) {
                PageCommon.ModalExportOpen({
                    tableName: 'F_Receipt_Refund',
                    menu_Id: 'M000008',
                    list_Id: 'ReceiptRefundList',
                    systemKey: 'FinancialManage',
                    vm: ReceiptRefund_vue
                })
            },
            ...
            //查询
            Search: function () {
                ReceiptRefund_vue.searchModel = $("#searchForm").GetSearchModel({ Menu_Id: "M000007", List_Id: "ReceiptRefundList" });
            },
            //清除
            mClear: function () {
                this.Receipt_Refund_Type = '';
                this.Customer_Id = '';
                this.Employee_Id = '';
                this.Department_Id = '';
                this.Return_Way = '';
