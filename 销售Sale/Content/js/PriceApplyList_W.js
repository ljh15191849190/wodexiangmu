    ...
    var vmPriceApply = new Vue({
        ...
        data: {
            ...
            tableUrl: "Seach",
            //表格查询条件
            searchModel: { Where_Parameter_List: [{ Field_Name: "M_Price_Apply.Is_Purchase", Query_Type: "01", Expression: "02", Condition_Value1: "1" }] },
            childSearchModel: [{
                //子表关联主表的外键
        ...
        methods: {
            ...
            Update: function () {
                ...
                window.location.href = PageCommon.SetUrlParameter("Detail_W", "relevantnumber=" + selectRow[0].Price_Apply_Id + ',' + selectRow[0].Customer_Id + '&sourcetype=0&isedit=0');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
            ...
            CheckLook: function () {
                ...
                window.location.href = PageCommon.SetUrlParameter("Detail_W", "relevantnumber=" + selectRow[0].Price_Apply_Id + ',' + selectRow[0].Customer_Id + '&sourcetype=0&isedit=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
            ...
            Approval: function () {
                ...
                //详细画面更新跳转
                window.location.href = PageCommon.SetUrlParameter("Detail_W", "relevantnumber=" + selectRow[0].Price_Apply_Id + ',' + '&sourcetype=1&isedit=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
            },
            //打印
            Print: function () {
            ...
            Search: function () {
                ...
                searchData.Where_Parameter_List.push({ Field_Name: "M_Price_Apply.Is_Purchase", Query_Type: "01", Expression: "02", Condition_Value1: "1" });
