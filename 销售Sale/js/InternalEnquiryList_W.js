    ...
    var Enqury_vue = new Vue({
        ...
        data: {
            ...
            tableUrl: "Seach",
            //表格查询条件
            searchModel: { Where_Parameter_List: [{ Field_Name: "M_Consult_Price_Bill.Is_Purchase", Query_Type: "01", Expression: "02", Condition_Value1: "1" }] },
            columHeaderSeach: {
                Menu_Id: "M000001",
                System_Key: "Sale",
                List_Id: ""
        ...
        methods: {
            ...
            CheckLook: function () {
                ...
                window.location.href = PageCommon.SetUrlParameter("Detail_W", "relevantnumber=" + selectRow[0].Consult_Price_Bill_Id + '&sourcetype=0&isedit=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
            ...
            Update: function () {
                ...
                //详细画面更新跳转
                window.location.href = PageCommon.SetUrlParameter("Detail_W", "relevantnumber=" + selectRow[0].Consult_Price_Bill_Id + '&sourcetype=0&isedit=0');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
            ...
            Search: function () {
                ...
                searchData.Where_Parameter_List.push({ Field_Name: "M_Consult_Price_Bill.Is_Purchase", Query_Type: "01", Expression: "02", Condition_Value1: "1" });
