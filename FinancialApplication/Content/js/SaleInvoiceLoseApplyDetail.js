  //联系人信息主键
    ...
    var Sale_Invoice_LoseApply_vue = new Vue({
        el: '#apps',
        data: {
            isedittable:false,
            Invoice_LoseApply: {
           ...
           //表格
            FA_Sale_Invoice_Apply_Lose_List: [],
            //联系人信息表头查询条件
            columHeaderSeach: {
                Menu_Id: "M000004",
                System_Key: "FinancialApplication",
                List_Id: "SaleInvoiceLostApplyDetailList"
            },
            ...
            if (relevantnumber) {
                PageCommon.GetFormData({
                    ...
                    , success: function (data) {
                        Sale_Invoice_LoseApply_vue.Invoice_LoseApply = data;
                        //判断状态
        ...
        methods: {
                ...
                if (result) {
                    PageCommon.GetFormData({
                        ...
                        success: function (data) {
                            ...
                            vm.FA_Sale_Invoice_Apply_Lose_List = data.DataContext;
                        }
                    });
                } else {
                    vm.FA_Sale_Invoice_Apply_Lose_List = [];
                }
            },
            ...
            Save: function () {
                ...
                if (Sale_Invoice_LoseApply_vue.FA_Sale_Invoice_Apply_Lose_List.length > 0) {
                    //var obj = {};
                    //obj.Sale_Invoice_Id = Sale_Invoice_LoseApply_vue.FA_Sale_Invoice_Apply_Lose_List[0].Sale_Invoice_Id;
                    //obj.Reason = vm.Invoice_LoseApply.Reason;
                    //提交数据到后台
                    Sale_Invoice_LoseApply_vue.Invoice_LoseApply.Sale_Invoice_Id = Sale_Invoice_LoseApply_vue.FA_Sale_Invoice_Apply_Lose_List[0].Sale_Invoice_Id;
                    PageCommon.SubmitForm({
                        url: "Save"
                     , param: { exceptionInvoiceApply: Sale_Invoice_LoseApply_vue.Invoice_LoseApply }
                     , success: function (data) {
                         //SourceType：列表0、审核1、提醒2   IsModfiy：0可修改 1不可修改
                         window.location.href = PageCommon.SetUrlParameter("Detail", "relevantnumber=" + data.Result_Model.Exception_Invoice_Apply_Id + '&save=1');
                     }
                    });
                } else {
            ...
            Approval: function () {
                ...
                PageCommon.SubmitForm({
                    ...
                    param: { exceptionInvoiceApply: Sale_Invoice_LoseApply_vue.Invoice_LoseApply },
                    success: function (data) {
                        window.location.href = PageCommon.SetUrlParameter("Detail", "relevantnumber=" + Sale_Invoice_LoseApply_vue.Invoice_LoseApply.Exception_Invoice_Apply_Id + ',' + '&sourcetype=0&isedit=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
                    }
                });
            },
            //审批意见
