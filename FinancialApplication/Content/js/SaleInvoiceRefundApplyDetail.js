    ...
    var Sale_Invoice_RefundApply_vue = new Vue({
        el: '#apps',
        data: {
            isedittable: false,
            SaleTable:false,
           ...
           //表格
            FA_Sale_Invoice_Apply_Refund_List: [],
            //第二张表 销售表
            ...
            columHeaderSeach: {
                ...
                List_Id: "SaleInvoiceRefundApplyDetailList"
            },
            //销售
            columHeaderSeach2: {
                Menu_Id: "M000002",
            ...
            if (relevantnumber) {
                PageCommon.GetFormData({
                    ...
                    , success: function (data) {
                        Sale_Invoice_RefundApply_vue.Invoice_InvalidApply = data;
                        //判断状态
        ...
        methods: {
            onchange: function (value) {
                ...
                if (value == 0) {
                    vm.SaleTable = true;
                    if (Sale_Invoice_RefundApply_vue.Invoice_InvalidApply.Invoice_Number) {
                        PageCommon.GetFormData({
                            url: "SaleBillDetailSeach",
                            param: { keyValue: [Sale_Invoice_RefundApply_vue.Invoice_InvalidApply.Invoice_Number] },
                            success: function (data) {
                                vm.FA_Sale_Invoice_List = data.DataContext;
                            }
                        });
                    }
                ...
                if (result) {
                    PageCommon.GetFormData({
                        ...
                        success: function (data) {
                            ...
                            vm.FA_Sale_Invoice_Apply_Refund_List = data.DataContext;
                        }
                    });
                } else {
                    vm.FA_Sale_Invoice_Apply_Refund_List = [];
                }
            },
            ...
            Save: function () {
                ...
                if (Sale_Invoice_RefundApply_vue.FA_Sale_Invoice_Apply_Refund_List.length > 0) {
                    //提交数据到后台
                    Sale_Invoice_RefundApply_vue.Invoice_InvalidApply.Sale_Invoice_Id = Sale_Invoice_RefundApply_vue.FA_Sale_Invoice_Apply_Refund_List[0].Sale_Invoice_Id;
                    PageCommon.SubmitForm({
                        url: "Save"
                     , param: { exceptionInvoiceApply: Sale_Invoice_RefundApply_vue.Invoice_InvalidApply }
                     , success: function (data) {
            ...
            Approval: function () {
                ...
                PageCommon.SubmitForm({
                    ...
                    param: { exceptionInvoiceApply: Sale_Invoice_RefundApply_vue.Invoice_InvalidApply },
                    success: function (data) {
                        window.location.href = PageCommon.SetUrlParameter("Detail", "relevantnumber=" + Sale_Invoice_RefundApply_vue.Invoice_InvalidApply.Exception_Invoice_Apply_Id + ',' + '&sourcetype=0&isedit=1');//sourcetype：列表0、审核1、提醒2   isedit：0可修改 1不可修改
                    }
                });
            },
            //审批意见
